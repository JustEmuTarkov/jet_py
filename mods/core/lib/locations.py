...
class ContainerInventory(GridInventory):
    def __init__(self, container):
        ...
        self.template = ItemTemplatesRepository().get_template(self.container['Items'][0]['_tpl'])
    ...
    def grid_size(self) -> Tuple[int, int]:
        ...
        grid_props = self.template['_props']['Grids'][0]['_props']
        width, height = grid_props['cellsH'], grid_props['cellsV']
        return width, height
...
class LocationGenerator:
    def __init__(self, location: str):
        ...
        self.__templates_repository = ItemTemplatesRepository()
    ...
    def __populate_container(self, container: dict):
        ...
        container_template = self.__templates_repository.get_template(container['Items'][0]['_tpl'])
        container_filter_templates: List[TemplateId] = container_template['_props']['SpawnFilter']
